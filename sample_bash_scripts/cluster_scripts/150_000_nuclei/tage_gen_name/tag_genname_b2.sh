...
aligned="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/genes/aligned_genes_b2.samAligned.out.sam"
out="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/genes/gen_tagged_b2.sam"
