...
#$ -l h_rt=03:00:00 -l h_vmem=1G -l h_stack=128M
...
bc_reads="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/batch_14/SRR6750055_2.fastq"
output="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/extracted_cbcs_umis"
umi_out_name="extracted_umis_b14"
cbc_out_name="extracted_cbcs_b14"
