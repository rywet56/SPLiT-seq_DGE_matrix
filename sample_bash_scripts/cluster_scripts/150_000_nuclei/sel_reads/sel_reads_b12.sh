...
path_to_cbcs_sam="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/aligned_cbs/aligned_cbcs_b12.sam"

path_to_bc_comb="/fast/AG_Ohler/manuel/splitseq/frozen_preserved_cells_nuclei_200_UBCs/barcode_combinations.fasta"

path_to_umis_fastq="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/extracted_cbcs_umis/extracted_umis_b12.fastq"

path_to_gen_fastq="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/batch_12/SRR6750053_1.fastq"

out_dir="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/sel_reads"

out_filename_bcs="selected_barcodes_b12"
out_filename_umis="selected_umis_b12"
out_filename_gen="selected_gens_b12"
