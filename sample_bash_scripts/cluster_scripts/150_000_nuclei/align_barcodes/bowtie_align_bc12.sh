...
barcodes="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/extracted_cbcs_umis/extracted_cbcs_b12.fastq"
output="/fast/AG_Ohler/manuel/splitseq/150000_nuclei/aligned_cbs/aligned_cbcs_b12.sam"
